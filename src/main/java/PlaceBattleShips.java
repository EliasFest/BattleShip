...
public class PlaceBattleShips {
    ...
    public static void placeBattleShips() {
        ...
        for (int i = 1; i <= BattleShip.BattleShips; ) {
            ...
            switch (direction) {
                case "o":
                    if ((x >= 0 && x < BattleShip.rows) && (y >= 0 && y < BattleShip.columns) && (BattleShip.grid[x][y] == "o " && (!BattleShip.grid[x][y].equals("X ") && !BattleShip.grid[x - 1][y].equals("X ")))) {
                ...
                case "u":
                    ...
                    break;
                case "l":
                    if ((x >= 0 && x < BattleShip.rows) && (y >= 0 && y < BattleShip.columns) && (BattleShip.grid[x][y] == "o " && (!BattleShip.grid[x][y].equals("X ") && !BattleShip.grid[x][y - 1].equals("X ")))) {
                        BattleShip.grid[x][y] = "X ";
